 ...
 *
 * Static preview page, not the real dashboard. It exists so the token set in
 * app/globals.css can be reviewed in one place. Move it to /styleguide or
 * delete it once the real order screens land.
 */
...
const NAV = [
  { label: "Orders", icon: Calendar03Icon, active: true },
  { label: "Deliveries", icon: TruckDeliveryIcon, active: false },
  { label: "Products", icon: Package02Icon, active: false },
  { label: "Customers", icon: UserGroupIcon, active: false },
  { label: "Reports", icon: Analytics01Icon, active: false },
];
    ...
    <div className="flex min-h-full">
      ...
      <aside className="hidden w-56 shrink-0 flex-col bg-sidebar text-sidebar-foreground lg:flex">
        <div className="flex h-14 items-center border-b border-sidebar-border px-5">
          <span className="text-sm font-semibold tracking-[0.22em] text-sidebar-accent-foreground">
            RALLA
          </span>
        </div>
        <nav className="flex-1 space-y-0.5 p-3">
          <p className="px-2 pt-2 pb-1.5 text-[10px] font-semibold tracking-wide text-sidebar-primary uppercase">
            Operations
          </p>
          {NAV.map((item) => (
            <a
        ...
        <div className="border-t border-sidebar-border p-3">
          <a
            href="#"
            className="flex items-center gap-2.5 rounded-md px-2 py-1.5 text-xs transition-colors hover:bg-sidebar-accent/60 hover:text-sidebar-accent-foreground"
          >
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        {/* ── Top bar ────────────────────────────────────────────────────── */}
        <header className="sticky top-0 z-10 flex h-14 shrink-0 items-center gap-4 border-b bg-card px-5">
          <span className="text-sm font-semibold tracking-[0.22em] lg:hidden">
            RALLA
          </span>
          <div className="hidden items-center gap-2 text-xs text-muted-foreground lg:flex">
            <span>Orders</span>
            <HugeiconsIcon icon={ArrowRight01Icon} size={12} strokeWidth={2} />
            <span className="font-medium text-foreground">Theme reference</span>
          </div>
        ...
        <main className="min-w-0 flex-1 space-y-8 px-5 py-6 lg:px-8 lg:py-8">
          <div>
        ...
        <footer className="border-t px-5 py-4 text-[11px] text-muted-foreground lg:px-8">
          RALLA · Internal admin · Theme reference
        </footer>
      </div>
    </div>
  );
